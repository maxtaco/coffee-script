...
o = (patternString, action, options) ->
  ...
  action = action.replace /\b(?:Block\.wrap|extend|awas)\b/g, 'yy.$&'
...
grammar =
  ...
  AwaitAssign: [
    o 'Assignable = AWAIT Expression',                -> awas $1, $4, yylineno
    o 'Assignable = TERMINATOR AWAIT Expression',     -> awas $1, $5, yylineno
    o 'Assignable = INDENT AWAIT Expression OUTDENT', -> awas $1, $5, yylineno
  ]
...
operators = [
  ...
  ['right',     'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS', 'AWAIT', 'WAITFOR']
  ['left',      'POST_IF']
]
