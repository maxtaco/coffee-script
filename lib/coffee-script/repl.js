...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, fs, getCommandId, iced, merge, nodeREPL, path, replDefaults, runInContext, updateSyntaxError, vm, _ref;
  ...
  replDefaults = {
    ...
    "eval": function(input, context, filename, cb) {
      var Assign, Block, Literal, Value, ast, err, js, referencedVars, ret, token, tokens, _ref1;
