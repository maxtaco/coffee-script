...
(function() {
  var ANONYMOUS_TAG, Lexer, SourceMap, base64encode, compile, ext, fn1, formatSourcePosition, fs, getSourceMap, helpers, i, icedTransform, len, lexer, parser, path, prepareStackTrace, ref, sourceMaps, source_map_support_lazy, sources, vm, withPrettyErrors,
  ...
  exports.compile = compile = withPrettyErrors(function(code, options) {
    ...
    if (options.inlineMap) {
      ...
      sourceURL = "//# sourceURL=" + ((ref1 = options.filename) != null ? ref1 : 'iced-coffee-script');
      js = js + "\n" + sourceMapDataURI + "\n" + sourceURL;
    }
  ...
  getSourceMap = function(filename, allowAnonymous) {
    var anonMap, answer;
    ...
    } else if (allowAnonymous && ((anonMap = sourceMaps[ANONYMOUS_TAG]) != null)) {
      return anonMap;
