...
(function() {
  var Lexer, SourceMap, base64encode, compile, ext, fn1, formatSourcePosition, fs, getSourceMap, helpers, i, icedTransform, len, lexer, parser, path, prepareStackTrace, ref, sourceMaps, source_map_support_lazy, sources, vm, withPrettyErrors,
  ...
  getSourceMap = function(filename, allowAnonymous) {
    ...
    } else if (allowAnonymous && (sourceMaps['<anonymous>'] != null)) {
